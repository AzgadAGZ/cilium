...
var (
	...
	ControlPlaneLeaderCells = []cell.Cell{
		...
		cell.Provide(func(cfg *operatorOption.OperatorConfig) cmapisrv.EndpointSliceExportSyncConfig {
			return cmapisrv.EndpointSliceExportSyncConfig{
				Enabled: cfg.SyncK8sServices,
			}
		}),
		cmapisrv.ServiceSyncCell,
		cmapisrv.EndpointSliceExportSyncCell,
